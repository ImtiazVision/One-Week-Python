...
# join() is a string method that joins together the elements of an iterable/list into a single string. Whatever string we call it on will be used as a separator. 
