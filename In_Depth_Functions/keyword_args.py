...
# Writing out the name of the parameter and its corresponding value is known as keyword argument when we call the function. This syntax of 'parameter name = value' is similar to default parameter except that default parameter is defined at the beginning of the function while keyword arguments are invoked during the function call at the end of the function. 